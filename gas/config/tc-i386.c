...
#if 0//temp
know(f.bitfield.cpuno64 == a.bitfield.cpuno64);
know(f.bitfield.cpu64 == a.bitfield.cpu64);
know(f.bitfield.cpuavx512vl == a.bitfield.cpuavx512vl);
know(f.bitfield.cpuavx512f == a.bitfield.cpuavx512f);
know(f.bitfield.cpuhle == a.bitfield.cpuhle);
know(f.bitfield.cpuavx == a.bitfield.cpuavx);
know(f.bitfield.cpu3dnowa == a.bitfield.cpu3dnowa);
know(f.bitfield.cpu3dnow == a.bitfield.cpu3dnow);
know(f.bitfield.cpu387 == a.bitfield.cpu387);
know(f.bitfield.cpu287 == a.bitfield.cpu287);
#endif
	  ...
	  && current_templates->start->opcode_modifier.isprefix)
	{
	  ...
	  if (current_templates->start->base_opcode == PSEUDO_PREFIX)
		...
		case PREFIX_DS:
		  ...
		  break;
		case PREFIX_REP:
		  if (current_templates->start->cpu.bitfield.cpuhle)
...
output_insn (void)
{
  ...
  if (IS_ELF && x86_used_note && now_seg != absolute_section)
	...
	x86_feature_2_used |= GNU_PROPERTY_X86_FEATURE_2_TMM;
	  ...
	  || i.tm.cpu.bitfield.cpu287
	  || i.tm.cpu.bitfield.cpu387
	  || is_cpu (&i.tm, Cpu687)
      ...
      if (i.index_reg)
	{
      ...
      /* vzeroall / vzeroupper */
      if (i.tm.base_opcode == 0x77 && i.tm.cpu.bitfield.cpuavx)
	i.xstate |= xstate_ymm;
	...
	x86_isa_1_used |= GNU_PROPERTY_X86_ISA_1_V3;
      if (i.tm.cpu.bitfield.cpuavx512f
	  || is_cpu (&i.tm, CpuAVX512BW)
	  || is_cpu (&i.tm, CpuAVX512DQ)
	  || i.tm.cpu.bitfield.cpuavx512vl
